...
# Project:  add-nbo.pro
# Template: app
# Command: /home/kali/Qt/5.15.0/gcc_64/bin/qmake -o Makefile add-nbo.pro
#############################################################################
...
INCPATH       = -I. -I. -I../../../../Qt/5.15.0/gcc_64/include -I../../../../Qt/5.15.0/gcc_64/include/QtGui -I../../../../Qt/5.15.0/gcc_64/include/QtCore -I. -isystem /usr/include/libdrm -I../../../../Qt/5.15.0/gcc_64/mkspecs/linux-g++
...
DISTDIR = /home/kali/bob/homework/0712/add-nbo/.tmp/add-nbo1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/kali/Qt/5.15.0/gcc_64/lib
LIBS          = $(SUBLIBS) /home/kali/Qt/5.15.0/gcc_64/lib/libQt5Gui.so /home/kali/Qt/5.15.0/gcc_64/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
moc_predefs.h: ../../../../Qt/5.15.0/gcc_64/mkspecs/features/data/dummy.cpp
	g++ -pipe -O2 -Wall -Wextra -dM -E -o moc_predefs.h ../../../../Qt/5.15.0/gcc_64/mkspecs/features/data/dummy.cpp
